---
title: "Multivariate Econometric Forcasting Sample Code"
...
setwd("C:/Users/rmcpherson/Documents/Projects/nautilus_property_analysis/quarterly_analysis")
dir.create("plots")
...
The figure below shows the forecast of incurred losses, versus the actual, based on the resulting GLMNet model on the leading indicators.
...
Based on this analysis, relatively short-term increases in certain unfavorable property exposure classifications were likely to result in a forecasted upward pressure on incurred losses.  However, there does not appear to be a systemic pattern in underwriting trends that would suggest an ongoing increase in incurred losses.  The observed increases in adverse exposure that had occurred a few quarters ago have not continued, and in fact, have been decreasing.  Therefore, the increase in the incurred loss trend that is forecasted is not likely to continue past a single quarter, and may level out over about a three quarter period thereafter.
A re-underwriting effort is a natural response to an increase in losses.  While it can always be healthy to re-evaluate a book of inforce business from an underwriting perspective, care may be advised in this case, so as to avoid disrupting the current book too much.  This analyses suggests that the problem may have fixed itself already.  Or, to give our underwriters more credit, they may well have already nipped this one in the bud, if current exposure class trends are an indication.
