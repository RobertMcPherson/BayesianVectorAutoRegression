...
dep.var <- Quandl("NHTSA/FTR_LTR_PK_US", api_key="DJGcfzQc5RYP1JSycMBv")
#str(dep.var)
...
plot(R,main="Plot of Correlations for Differenced Data")

plot(R.test,main="Plot of P-Values for Differenced Data")
...
```
The best lag for the data is `r best.lag` years. The correlation coefficient for the best lag is `r best.correlation`.  The sign of the correlation coefficient is `r direction`.
